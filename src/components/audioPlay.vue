...
<div class="audio">
  ...
  <div class="audioContainer">
    ...
    <!-- @pause="onPause"
          ...
          controls="controls" -->
    <audio :src="file" ref="audio" style="display:none;" autoplay @timeupdate="onTimeupdate" @loadedmetadata="onLoadedmetadata" @ended="onEnd">亲 您的浏览器不支持html5的audio标签</audio>
  </div>
</div>
</template>
